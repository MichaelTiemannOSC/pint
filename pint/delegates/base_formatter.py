...
class Formatter:
    ...
    def __init__(
        ...
        dim_order: Optional[list[str]] = [ "[substance]", "[mass]", "[current]", "[luminosity]", "[length]", "[]", "[time]", "[temperature]", ]
    ):
...
class PrettyFormatter(Formatter):
    ...
    def format_pretty(self, unit: UnitsContainer, registry: UnitRegistry, **options) -> str:
...
class HtmlFormatter(Formatter):
    ...
    def format_html(self, unit: UnitsContainer, registry: UnitRegistry, **options) -> str:
        return self.formatter(
            unit.items(),
            as_ratio=True,
            single_denominator=True,
...
class DefaultFormatter(Formatter):
    ...
    def format_default(self, unit: UnitsContainer, registry: UnitRegistry, **options) -> str:
        return self.formatter(
            unit.items(),
            as_ratio=True,
            single_denominator=False,
...
class CompactFormatter(Formatter):
    ...
    def format_compact(self, unit: UnitsContainer, registry: UnitRegistry, **options) -> str:
        return self.formatter(
            unit.items(),
            as_ratio=True,
            single_denominator=False,
